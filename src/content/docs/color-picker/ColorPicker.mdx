...
- `Color` property contains nested properties you may bind to or use to retrieve the color in code-behind:
  ...
  - `Color.HSV_H`: Hue in the HSV color space, a 0-360 double  - `Color.HSV_S`: Saturation in the HSV color space, a 0-100 double
...
See [AvaloniaUI Styling](color-picker-avaloniaui)

## WPF

See [WPF Styling](color-picker-wpf)
