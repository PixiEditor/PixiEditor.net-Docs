---
title: Terms Of Service (30.07.2026)
slug: terms-of-service-30-07-26
---
...
Capitalized words used in the TOS have the following meanings:
  ...
  - **Account** - a panel created as part of the PixiPack or Extensions purchase process, which is used to verify product purchases and allows to link a Digital Goods to a specific e-mail address;
  ...
  - **Digital Goods -** digital content, which may be purchased by the User via Marketplace - PixiPack and Extensions. Digital Goods are additional App add-ons and are not standalone products;
  ...
  - **Founder's Pack -** a starter package offered under a commercial license that provided additional features for the App. As of July 30th, 2026, Founder's Pack is no longer available for purchase;
  - **PixiPack -** a supporter package offered under a commercial license that provides additional features for the App. PixiPack may be marketed under year-specific names (e.g. "PixiPack 2026"), which refer to the same Digital Goods defined here;
  ...
  - **License Agreement** - an agreement under which the User may use the Digital Goods, subject to the terms and conditions described in the TOS and in the profile of the PixiPack or specific Extensions;
...
- As part of the purchase of Digital Goods - it is necessary to create an Account. Account is created in accordance with the provisions below - depending on whether the account is created during the purchase of a PixiPack or an Extension.
...
- User has the option to purchase PixiPack through the PixiEditor website. PixiPack is available in three tiers: Silver, Gold and Diamond. For information on PixiPack functionalities and the differences between tiers, visit [https://pixieditor.net/download/](https://pixieditor.net/download/).
- In order to purchase the PixiPack, User needs to:
  - access the [https://pixieditor.net/download/](https://pixieditor.net/download/);
  - click on the price button of chosen tier;
...
- In order to use the PixiPack, User must open the App and then click on the Account icon (in the upper right corner) and enter the e-mail address used to purchase the PixiPack. After providing a valid e-mail address, the User immediately receives access to the PixiPack, associated with the e-mail address.
- Once User enters e-mail address in the App, as described in Section 5, the PixiPack becomes available.
...
- In order to purchase Extension, User needs to:
  ...
  - select Extension;
  - log in to the Account (if User has a PixiPack, Founder's Pack or have made previous purchases of Extensions) or complete User e-mail address and register Account by clicking on the activation link that will be sent to the e-mail address provided;
...
- The current version of the TOS is effective from 30.07.2026.
