...
In an event of a crash, a report containing diagnostic data will be automatically sent to us via Discord and to our servers. The report includes:
...
- Commands you execute (actions like opening a file, creating a new document, etc. Each user interaction that changes the document/image is counted as a command. UI clicks are not tracked),
