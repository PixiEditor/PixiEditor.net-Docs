...
6. Run PixiEditor.Desktop project
    ...
    Either open `PixiEditor/src/PixiEditor.sln` in your IDE of choice or run the following commands in terminal:
    ...
    ```
    dotnet run --project PixiEditor.Desktop/PixiEditor.Desktop.csproj -r win-x64
    ```
    </TabItem>
    <TabItem label="Linux">
    ```
    dotnet run --project PixiEditor.Desktop/PixiEditor.Desktop.csproj -r linux-x64
    ```
    </TabItem>
    <TabItem label="macOS">
    ```
    dotnet run --project PixiEditor.Desktop/PixiEditor.Desktop.csproj -r osx-arm64
    ```
