...
:::tip
Before you continue, make sure to read <a href="/docs/handbook/animating/getting-started">getting started guide</a>.
:::
...
Think of it this way: layer is an animation with a single cel, you can just add more cels to it by using the <a href="/docs/handbook/animating/getting-started#timeline">Timeline</a>
...
Marked elements with red outline are the same thing. Order of the layers inside the <a href="/docs/handbook/animating/getting-started#timeline">Timeline</a> is also exactly the same as in the Layers panel.

Layer will not show in the <a href="/docs/handbook/animating/getting-started#timeline">Timeline</a> unless you create a cel for it. Hit 
