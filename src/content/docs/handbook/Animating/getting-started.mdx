...
For more information, check out a [dedicated guide](/docs/handbook/animating/frame-by-frame)

## Procedural Animations

PixiEditor gives full freedom over animations, meaning you can animate almost any property within the [Node Graph](/docs/handbook/node-graph/getting-started-with-node-graph). 
...
For more information, check out a [dedicated guide](/docs/handbook/animating/procedural)