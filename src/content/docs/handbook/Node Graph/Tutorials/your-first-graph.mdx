...
If you didn't read the [Getting Started with Nodes](/docs/handbook/node-graph/getting-started-with-node-graph) guide, we recommend you to do so first. It will help you understand the basics of nodes and how they work.
...
To learn more about sockets, check out the [Sockets](/docs/handbook/node-graph/property-sockets) guide.