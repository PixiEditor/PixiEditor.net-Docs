...
PixiEditor uses SKSL in the Node Graph's [Shader](/docs/handbook/node-graph/nodes/effects/shader) node, allowing you to create custom shader effects by writing SKSL code directly.
