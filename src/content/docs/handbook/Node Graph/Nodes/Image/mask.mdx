...
node:
  ...
  - name: Invert
    type: Boolean
    description: 'Whether to invert the mask. If true, the areas defined by the mask will be hidden and the rest will be visible.'
    default: 'False'
    isContextful: false
  outputs:
  - name: Output
...
For more information about masks, see the [Masking](/docs/handbook/layers/masking) docuementation.